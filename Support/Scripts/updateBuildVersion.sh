...
ORIGINAL_BUNDLE_VERSION=`sed -n '/CURRENT_PROJECT_VERSION/{s/CURRENT_PROJECT_VERSION = //;s/;//;s/^[[:space:]]*//;p;q;}' ./MacMagazine/${project_name}.xcodeproj/project.pbxproj`
...
echo ""
sed -i '' -e 's/CURRENT_PROJECT_VERSION \= [^\;]*\;/CURRENT_PROJECT_VERSION = '${bundle_version}';/' ./MacMagazine/${project_name}.xcodeproj/project.pbxproj 

# ---- REPLACED BUILD VERSION ----
REPLACED_BUNDLE_VERSION=`sed -n '/CURRENT_PROJECT_VERSION/{s/CURRENT_PROJECT_VERSION = //;s/;//;s/^[[:space:]]*//;p;q;}' ./MacMagazine/${project_name}.xcodeproj/project.pbxproj`
