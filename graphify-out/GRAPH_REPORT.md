# Graph Report - MacMagazine  (2026-07-21)

## Corpus Check
- 334 files · ~363,533 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2828 nodes · 5293 edges · 200 communities (172 shown, 28 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 635 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40a0a3d1`
...
Cohesion: 0.12
Nodes (6): SettingsViewModel, Binding, Database, News, PersistentModel, SettingsViewModelTests
...
Cohesion: 0.09
Nodes (11): AnalyticsLibrary, AppTrackingTransparency, EnvironmentValues, Bool, MacMagazineLibrary, Observation, StoreKit, SwiftUI (+3 more)
...
Cohesion: 0.15
Nodes (10): Int, Bool, Utils, HTTPCookie, ColorScheme, dark, light, system (+2 more)
...
Cohesion: 0.07
Nodes (10): Foundation, String, NewsTests, URLs, MMLiveLibrary, NetworkLibrary, StorageLibrary, SwiftData (+2 more)
...
Cohesion: 0.16
Nodes (11): FullPlayerView, PlayerAccessibilityPriority, AnalyticsManager, Bool, Color, Data, Double, PodcastDB (+3 more)
...
Cohesion: 0.15
Nodes (9): AVPlayer, AVPlayerItem, CMTime, Float, PodcastPlayerManager, Any, Double, PodcastDB (+1 more)

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (16): Codable, News, all, appletv, highlights, news, reviews, rumors (+8 more)

### Community 24 - "Community 24"
Cohesion: 0.12
Nodes (8): FirebaseCore, InAppLibrary, LoggerLibrary, String, OneSignalFramework, os, PassKit, UIKit
...
Cohesion: 0.11
Nodes (15): AnalyticsManager, Binding, Bool, Database, ScrollPosition, String, VideosView, APIStatus (+7 more)
...
Cohesion: 0.25
Nodes (9): CaseIterable, areEqual(), Equatable, Bool, Text, MainView, CaseIterable, String (+1 more)
...
Cohesion: 0.09
Nodes (20): AppTabs, live, news, search, settings, social, Social, instagram (+12 more)
...
Cohesion: 0.13
Nodes (13): AnalyticsConstants, SessionState, Bool, SceneView, PushNotification, MainViewModel, Bool, Database (+5 more)
...
Cohesion: 0.27
Nodes (7): CGSize, PodcastImageView, Content, Data, FeedRowView, FeedDB, View
...
Cohesion: 0.19
Nodes (12): Data, PodcastBackgroundGradientStyle, fourTone, threeTone, twoTone, BackgroundGradientStatus, BackgroundViewModel, Binding (+4 more)
...
Cohesion: 0.21
Nodes (3): FeedLibrary, Constants, MacMagazineUILibrary
...
Cohesion: 0.15
Nodes (10): Gesture, PodcastMiniPlayerModifier, AnalyticsManager, Content, View, MiniPlayerView, AnalyticsManager, Color (+2 more)
...
Cohesion: 0.21
Nodes (10): View, FavoriteButton, Bool, String, Void, ReadButton, Bool, Void (+2 more)
...
### Community 179 - "View"
Cohesion: 0.09
Nodes (22): ShortcutActions, none, openLastSeenPost, openMostRecentPost, openSearchPost, ShortcutManager, ModelContext, String (+14 more)
...
Cohesion: 0.29
Nodes (4): AVFoundation, Combine, Array, Self
...
Cohesion: 0.25
Nodes (7): EnvironmentValues, String, Color, ThemeColor, IconsView, AnalyticsManager, Themeable
...
Cohesion: 0.33
Nodes (4): AppearanceViewModel, Database, AppearanceView, AnalyticsManager
...
## Knowledge Gaps
- **476 isolated node(s):** `post-tool-use.sh script`, `stop.sh script`, `$schema`, `Read`, `Grep` (+471 more)
...
- **Why does `Foundation` connect `FeedLibrary Imports` to `Live Content & Notifications`, `Analytics Library`, `XML Feed Parsing`, `Card Content & Menus`, `Community 145`, `Podcast Chapter Colors`, `Search ViewModel Tests`, `Community 24`, `Community 29`, `Community 36`, `Community 40`, `Community 43`, `Community 44`, `Community 51`, `View`, `Community 53`, `Community 56`, `PodcastPlayerManager.swift`, `Community 58`, `Community 59`, `ThemeColor.swift`, `NewsCategory`, `Community 63`, `Community 64`, `Community 65`, `Community 68`, `NewsCategoryExtensions.swift`, `ArrayExtensions.swift`, `Community 70`, `Community 73`, `Community 78`, `Community 80`, `Community 85`, `Community 92`, `Community 95`, `Community 100`, `Community 109`, `Community 110`, `Community 120`?**
  _High betweenness centrality (0.177) - this node is a cross-community bridge._
- **Why does `SwiftUI` connect `Analytics Library` to `Community 128`, `Live Content & Notifications`, `Settings & Subscriptions`, `Community 132`, `WebView HTML & Disqus`, `FeedLibrary Imports`, `Community 140`, `Card Content & Menus`, `Community 146`, `Podcast Chapter Colors`, `Search System`, `Community 149`, `Community 24`, `Community 36`, `Community 49`, `MinimumTouchTarget`, `Community 51`, `Community 53`, `.makeHTML`, `PodcastPlayerManager.swift`, `ThemeColor.swift`, `Community 67`, `Community 71`, `Community 81`, `Community 84`, `Community 91`, `Community 92`, `Community 94`, `Community 95`, `Community 99`, `Community 101`, `Community 102`, `Community 105`, `Community 112`, `Community 117`, `Community 118`, `Community 119`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `MacMagazineLibrary` connect `Analytics Library` to `Community 68`, `Community 36`, `NewsCategoryExtensions.swift`, `ArrayExtensions.swift`, `FeedLibrary Imports`, `Community 80`, `Community 145`, `Community 53`, `PodcastPlayerManager.swift`, `Community 89`, `Community 24`, `Community 95`?**
